        ...
        <div className="sidebar_menu">
          ...
          <div className="sid_menus_all">
            ...
            <div className="dropdown">
              ...
              <div className="menu_dropdown">
                ...
                <Link className="dropdown-item" to="/">
                  {" "}
                  <span className="iconnav">
                    <img className="iconnav" src={icon6} alt="icon" />
                  </span>
                  Links
                </Link>
                <Link className="dropdown-item" to="/">
            ...
            <Link to="/">
              {" "}
              <span className="iconnav">
                <img className="iconnav" src={icon9} alt="icon" />
              </span>
              Social
            </Link>
            <Link to="/">
              {" "}
              <span className="iconnav">
                <img className="iconnav" src={icon10} alt="icon" />
              </span>
              NFTs
            </Link>
            ...
            <Link to="/">
              <span className="iconnav">
                <img className="iconnav" src={icon11} alt="icon" />
              </span>
              Promo & PDFs
            </Link>
